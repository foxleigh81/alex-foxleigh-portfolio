...
The component file should be named `index.tsx` as this allows the component to be referenced via the folder name only in imports (e.g. `@afp/components/progress-indicator` instead of `@afp/components/progress-indicator/progress-indicator`).
